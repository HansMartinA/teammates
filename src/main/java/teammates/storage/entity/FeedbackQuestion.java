...
this.showRecipientNameTo = showRecipientNameTo == null ? new  ArrayList<>() : showRecipientNameTo;
...
return untrimmedId.replaceFirst("KIBAA$", "AogEA").substring(0, untrimmedId.length() - 4);
}
