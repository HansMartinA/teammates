...
String[]  searchableTexts = {instructor.getName(), instructor.getEmail(), instructor.getCourseId(), course == null ? "" : course.getName(), instructor.getGoogleId(), instructor.getRole(), instructor.getDisplayedName()};
