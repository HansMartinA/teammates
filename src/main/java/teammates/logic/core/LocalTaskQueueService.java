...
HttpPost post = new  HttpPost(createBasicUri("http://localhost:" + Config.getPort() + task.getWorkerUrl(), task.getParamMap()));
if (task.getRequestBody() != null)
{
StringEntity entity = new  StringEntity(JsonUtils.toCompactJson(task.getRequestBody()), Const.ENCODING);
