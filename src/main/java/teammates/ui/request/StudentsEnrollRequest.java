...
private static final String ERROR_MESSAGE_DUPLICATE_EMAIL = "Error, duplicated email addresses detected in the input: %s";

private static final String ERROR_MESSAGE_EMPTY_ENROLLMENT = "The enroll line is empty. " + "Please input at least one student detail.";
...
for (StudentEnrollRequest request : studentEnrollRequests)
{
assertTrue(!emails.contains(request.getEmail()), String.format(ERROR_MESSAGE_DUPLICATE_EMAIL, request.getEmail()));
