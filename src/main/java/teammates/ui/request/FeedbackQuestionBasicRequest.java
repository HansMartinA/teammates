...
FeedbackQuestionDetails details = JsonUtils.fromJson(JsonUtils.toCompactJson(questionDetails), questionType.getQuestionDetailsClass());
details.setQuestionText(questionBrief);
if (questionType == FeedbackQuestionType.CONSTSUM_OPTIONS || questionType == FeedbackQuestionType.CONSTSUM_RECIPIENTS)
{
...
case CUSTOM: return customNumberOfEntitiesToGiveFeedbackTo;
case UNLIMITED: return Const.MAX_POSSIBLE_RECIPIENTS;
default: assert false : "Unknown numberOfEntitiesToGiveFeedbackToSetting: " + numberOfEntitiesToGiveFeedbackToSetting;
break;
...
List<FeedbackParticipantType> showResponsesTo = this.convertToFeedbackParticipantType(this.showResponsesTo);
if (this.questionType == FeedbackQuestionType.CONTRIB && this.giverType == FeedbackParticipantType.STUDENTS && this.recipientType == FeedbackParticipantType.OWN_TEAM_MEMBERS_INCLUDING_SELF && showResponsesTo.contains(FeedbackParticipantType.OWN_TEAM_MEMBERS))
{
...
private  List<FeedbackParticipantType> convertToFeedbackParticipantType(List<FeedbackVisibilityType> feedbackVisibilityTypes) {
return feedbackVisibilityTypes.stream().map(feedbackVisibilityType -> {
switch (feedbackVisibilityType) {
case STUDENTS: return FeedbackParticipantType.STUDENTS;
case INSTRUCTORS: return FeedbackParticipantType.INSTRUCTORS;
case RECIPIENT: return FeedbackParticipantType.RECEIVER;
case GIVER_TEAM_MEMBERS: return FeedbackParticipantType.OWN_TEAM_MEMBERS;
case RECIPIENT_TEAM_MEMBERS: return FeedbackParticipantType.RECEIVER_TEAM_MEMBERS;
default: assert false : "Unknown feedbackVisibilityType" + feedbackVisibilityType;
break;
...
public  void setNumberOfEntitiesToGiveFeedbackToSetting(NumberOfEntitiesToGiveFeedbackToSetting numberOfEntitiesToGiveFeedbackToSetting) {
