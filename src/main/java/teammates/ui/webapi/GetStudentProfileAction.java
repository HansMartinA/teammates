...
private static final String MESSAGE_NOT_STUDENT_ACCOUNT = "You did not login as a student," + " so you cannot view your profile";

private static final String MESSAGE_STUDENT_NOT_FOUND = "The student is not in the course you are given," + " so you cannot access the profile.";
...
gateKeeper.verifyAccessibleForCurrentUserAsInstructorOrTeamMember(userInfo.id, courseId, student.getSection(), studentEmail);
}
}
