...
{
throw new  InvalidHttpRequestBodyException("The uploaded profile picture was too large. " + "Please try again with a smaller picture.");
}
if (!image.getContentType().startsWith("image/"))
{
throw new  InvalidHttpRequestBodyException("The file that you have uploaded is not a picture. " + "Please upload a picture (usually it ends with .jpg or .png)");
}
