...
switch (intent) {
case INSTRUCTOR_SUBMISSION: case INSTRUCTOR_RESULT: String courseId = getNonNullRequestParamValue(Const.ParamsNames.COURSE_ID);
...
switch (intent) {
case INSTRUCTOR_SUBMISSION: case INSTRUCTOR_RESULT: instructorAttributes = getInstructorOfCourseFromRequest(courseId);
break;
case FULL_DETAIL: instructorAttributes = logic.getInstructorForGoogleId(courseId, userInfo.getId());
break;
default: throw new  InvalidHttpParameterException("Unknown intent " + intent);
