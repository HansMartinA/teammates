...
if (emailType.equals(EmailType.FEEDBACK_SESSION_REMINDER.name()))
{
...
email = emailGenerator.generateFeedbackSessionReminderEmails(feedbackSession, Collections.singletonList(student), new  ArrayList<>(), null).get(0);
}
else
{
