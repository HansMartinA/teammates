...
try {
FeedbackSessionAttributes unpublishFeedbackSession = logic.unpublishFeedbackSession(feedbackSessionName, courseId);
if (unpublishFeedbackSession.isPublishedEmailEnabled())
{
taskQueuer.scheduleFeedbackSessionUnpublishedEmail(unpublishFeedbackSession.getCourseId(), unpublishFeedbackSession.getFeedbackSessionName());
}
