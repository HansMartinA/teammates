...
logic.updateOrCreateStudentProfile(StudentProfileAttributes.updateOptionsBuilder(studentId).withShortName(studentProfile.getShortName()).withEmail(studentProfile.getEmail()).withGender(studentProfile.getGender()).withNationality(studentProfile.getNationality()).withInstitute(studentProfile.getInstitute()).withMoreInfo(studentProfile.getMoreInfo()).build());
...
StudentProfileAttributes editedProfile = StudentProfileAttributes.builder(studentId).build();
