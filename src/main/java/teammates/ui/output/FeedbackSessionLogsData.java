...
public  FeedbackSessionLogsData(Map<String, List<FeedbackSessionLogEntry>> groupedEntries, Map<String, StudentAttributes> studentsMap, Map<String, FeedbackSessionAttributes> sessionsMap){
this.feedbackSessionLogs = groupedEntries.entrySet().stream().map(entry -> {
